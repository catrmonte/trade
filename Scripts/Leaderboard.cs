...
public class Leaderboard : MonoBehaviour
{
    ...
    void UpdateLeaderboardUI(List<PlayerLeaderboardEntry> leaderboard)
    {
        ...
        {
            // test here to figure out whats not workin
            Debug.Log("Test thing: " + leaderboardEntries[x].transform.Find("PlayerName"));
            ...
            leaderboardEntries[x].transform.Find("ScoreText").GetComponent<TextMeshProUGUI>().text = (-(float)leaderboard[x].StatValue * 0.001f).ToString("F0");
    ...
    {
        Debug.Log("Setting entry of " + newScore);
